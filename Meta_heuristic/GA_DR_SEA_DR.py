...
problem_name='validation_small.xlsx'
if problem_name=='validation_big.xlsx':
    ...
    T=8
    B_T = 7.5
elif problem_name=='validation.xlsx':
    B=50
    T=10
    B_T = 5
elif problem_name=='validation_small_big.xlsx':
    B=60
    T=6
    B_T = 10
elif problem_name=='validation_small_busy.xlsx':
    B=30
    T=4
    B_T = 7.5
...
df.to_excel(problem_name + '_GA_DR.xlsx')
