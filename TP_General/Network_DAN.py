...
class PPO(nn.Module):
    def __init__(self, learning_rate, lmbda, gamma, alpha, beta, epsilon, discount_factor,
        ...
        self.gnn = CrystalGraphConvNet(orig_node_fea_len=int(2*self.transporter_type), orig_edge_fea_len=(3+self.transporter_type), edge_fea_len=self.edge_fea_len, node_fea_len=self.node_fea_len, final_node_len=32, dis=dis)
