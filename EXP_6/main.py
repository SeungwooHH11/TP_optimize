...
if __name__=="__main__":
    ...
    ppo=PPO( learning_rate=0.0001, lmbda=0.95, gamma=1, alpha=0.5, beta=0.01, epsilon=0.2, discount_factor=1,location_num=location_number)

    number_of_problem=50  # 한번에 몇개의 문제를
    number_of_batch=10  # 문제당 몇 episode씩 한번에 학습할껀지
    number_of_trial=100  # #이를 몇번 반복할껀지
    number_of_iteration=100  # 전체 iteration #iteration 단위로 문제 변화
    problem = []
