...
class Problem_sampling:
    def __init__(self,block_number,location_number,transporter_type,dis,transporter_number,ready_high,tardy_high,gap,dis_high):
    ...
    def sample(self):
        ...
        for i in range(self.Block_Number):
            ...
            Block[i, 3] = 0   # ready time
            Block[i, 4] = 1 - Block[i, 2]  # tardy time
